package etable.domain.perfilmesa.model;
...
public class PerfilMesa {
	...
	private boolean pmcompuesta;
	
	public PerfilMesa() {
		
	}

	public PerfilMesa(int cperfilmesa, String pmnombre, String pmdescripcion, int pmcapacidad, boolean pmcompuesta) {
		super();
	...
	public boolean isPmcompuesta() {
		return pmcompuesta;
	}

	public void setPmcompuesta(boolean pmcompuesta) {
		this.pmcompuesta = pmcompuesta;
	}
