...
(1, 'Configuración del Sistema General', 'Este permiso permite hacer modificaciones sobre la información del Restaurante, habilitar o desahilitar el sistema, entre otros temas sobre el Sistema en general.', 1),
(2, 'Configuración de Parámetros Generales', 'Este permiso permite hacer modificaciones de los parámetros generales en base al Restaurante, como la cantidad de mesas que tendrá, máximo de usuarios, horario de atención, etc.', 1),
